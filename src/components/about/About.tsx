    ...
    <article className="flex flex-col min-h-screen sm:col-span-5 md:col-span-4 items-center">
      ...
      <section className="flex flex-col items-center mt-10 text-2xl gap-5 text-slate-600 p-2">
        <p className="text-base  sm:text-lg ">
          ...
          My name is Ekaterine Mitagvaria, and I come from the beautiful city of
          Tbilisi, Georgia. Programming is my passion, and I love every moment I
          spend immersed in it. The joy of creating something from scratch and
          bringing ideas to life is an absolute pleasure for me.{" "}
        </p>
        <p className="text-base  sm:text-lg ">
          Besides programming, another great love of mine is photography. I
          don't carry any heavy cameras; instead, I rely on my trusty iPhone to
          capture the essence of every new place I visit. These photographs
        ...
        <p className="text-base  sm:text-lg ">
          ...
          America, particularly Argentina, a trip that left me awe-inspired and
          hungry for more adventures. Exploring its diverse cities and natural
          wonders was an experience like no other, and it fueled my passion for
          capturing moments through my lens.
        </p>
        <p className="text-base  sm:text-lg ">
          To express my passions and share my travel experiences, I've created a
          YouTube channel. It's not just a hobby; it's a way for me to connect
          with fellow travelers and enthusiasts, inspiring their curiosity and
          igniting their desire to explore.{" "}
        </p>
        <p className="text-base  sm:text-lg ">
          ...
          sceneries, I know that these pursuits will always be an essential part
          of who I am.
        </p>
      </section>
